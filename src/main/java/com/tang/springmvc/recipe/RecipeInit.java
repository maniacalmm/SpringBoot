package com.tang.springmvc.recipe;

import com.tang.springmvc.recipe.Model.*;
...
public class RecipeInit implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public RecipeInit(CategoryRepos categoryRepository, RecipeRepos recipeRepository, UnitOfMeasureRepos unitOfMeasureRepository) {
